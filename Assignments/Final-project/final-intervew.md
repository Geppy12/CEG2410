...
### My Name: Bryce Gephart

### My Interviewers Dane sowereds , Aidan McGhaon , Steven Ray

Add a bullet in form form: `* Sowerds` for each person **who interviewed you** about your self-hosted implementation. Minimum of one is required.

### Who I Interviewed Dane sowereds , Steven Ray , Aidan McGhao

Add a bullet in form form: `* Sowereds` for each person **who you interviewed** about their self-hosted implementation. Minimum of three is required.
...
* Made Account = (sowereds) yes (adian) yes
* Joined server = (sowereds) yes (adain) yes
* Viewed Dashboard = (sowerds) yes (adain) yes
...
* According to dane I need to fix... nothing
* Bryce needs to fix... access
